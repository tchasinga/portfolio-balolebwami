    ...
    <div>
      <div className="font-poppins container font-sans static flex-col px-32 mt-32 w-full gap-14">
        <div className="mainH1">
          <h1
            className={`text-5xl  font-bold text-white fade-in-animation ${
              isTextVisible ? "show" : ""
            }`}
          >
        ...
        <div className="myCodeSpace flex mt-32 gap-6 items-center">
          ...
          <div className="flex-col w-full">
            ...
            <p className="text-gray-500 text-sm font-sans">
              ...
              technologies and
              <br />
              Developing new projects. I'm currently looking for a job as a Full
              Stack Developer. Where I can learn more about the field and
              improve
              <br />
              My skills. I will be happy to work with you. I've strong skills in
              HTML, CSS, JavaScript, <strong>NextJs</strong>,{" "}
              <strong>Ruby on Rails</strong>, <strong>Java</strong>,{" "}
              <strong>React</strong>, <strong>Node.js</strong>,{" "}
              <strong>Express.js</strong>, <strong>MongoDB</strong>,{" "}
              <strong>MySQL</strong>, <strong>Git</strong>,{" "}
              <strong>GitHub</strong>, and <strong>Render</strong>. I'll be
              overjoyed about working with you.
            </p>
          </div>
        </div>
      </div>
