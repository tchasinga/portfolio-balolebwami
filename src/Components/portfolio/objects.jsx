import projectOne from "./project/DesignOne.png";
import projectTwo from "./project/DesignTwo.png";
...
import projectNine from "./project/CloseLast.png";
...
const options = [
...

  {
    ...
    getView: "https://tchasinga.github.io/API-capstone-project/dist/",
    getGithub: "https://github.com/tchasinga/API-capstone-project",
  },

  {
    ...
    getView: "https://book-storing.onrender.com/",
    getGithub: "https://github.com/tchasinga/API-capstone-project",
  },
  ...
  },
  {
    ...
    UrlImg: projectNine,
    description: "Share sensitive information only on official, secure websites. ... The Individuals with Disabilities Education Act (IDEA) is a law that makes available a free appropriate public education to eligible children with disabilities throughout the nation and ensures special education and related ...",
    getView: "https://public-information.netlify.app",
    getGithub: "https://github.com/tchasinga/public-idea-information"
  }
];
